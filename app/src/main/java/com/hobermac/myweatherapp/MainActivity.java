...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        btn_WeatherByID.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                weatherDataService.getCityForecastByID(et_dateInput.getText().toString(), new WeatherDataService.ForecastByIDResponse() {
                    @Override
        ...
        btn_getWeatherByName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                weatherDataService.getCityForecastByName(et_dateInput.getText().toString(), new WeatherDataService.GetCityForecastByNameCallback() {
                    @Override
                    public void onError(String message) {
                        Toast.makeText(MainActivity.this, "something wrong", Toast.LENGTH_SHORT).show();
                    }
