...
public class WeatherReportModel {
    ...
    public float getThe_tamp() {
        return the_temp;
    }

    public void setThe_tamp(float the_tamp) {
        this.the_temp = the_tamp;
    }
