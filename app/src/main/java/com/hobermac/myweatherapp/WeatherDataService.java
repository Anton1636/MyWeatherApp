...
public class WeatherDataService {
    ...
    public void getCityID(String cityName, VolleyResponseListener volleyResponseListener)
    {
        ...
        WeatherSingleton.getInstance(context).addToRequestQueue(request);
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for(int i =0; i < consolidated_weather_list.length(); i++)
                    {
                        ...
                        one_day_weather.setApplicable_date(first_day_from_api.getString("application_date"));
                        ...
                        one_day_weather.setThe_tamp(first_day_from_api.getLong("the_temp"));
